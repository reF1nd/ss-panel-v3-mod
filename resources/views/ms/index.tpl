...
{block name='main'}
    <main class="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-8 col-lg-offset-2 col-sm-offset-2  col-md-8 col-md-offset-2">
                    <section class="content-inner margin-top-no">
                        <div class="col-lg-12 col-sm-12">
                            <div class="card ">
                                <div class="card-main">
                                    <div class="card-inner min-height-450">
                                        <p class="card-heading" style="font-size: 35px;">{$config["appName"]}</p>
                                    ...
                                    <div class="card-action">
                                        {if $user->isLogin}
                                            <div class="card-action">
                                                ...
                                                <div class="card-action-btn pull-left">
                                                <a class="btn btn-flat waves-attach waves-light waves-effect" href="/user/logout"><span
                                        ...
                                        {else}
                                            <div class="card-action-btn pull-left">
                                                <a class="btn btn-flat waves-attach waves-light waves-effect"
                                                   href="/auth/register"><span class="icon">pregnant_woman</span>&nbsp;注册</a>
                                            </div>
                                            <div class="card-action-btn pull-left">
                                                <a class="btn btn-flat waves-attach waves-light waves-effect"
