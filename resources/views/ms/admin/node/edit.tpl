                        ...
                        <div class="card">
                            <div class="card-main">
                                <div class="card-inner">
                                    ...
                                    <div class="form-group form-group-label">
                                        <label class="floating-label" for="server">节点IP(不填则自动获取，填写请按照 <a
                                                    href="https://github.com/esdeathlove/ss-panel-v3-mod/wiki/%E8%8A%82%E7%82%B9IP%E5%A1%AB%E5%86%99%E8%A7%84%E5%88%99">这里</a>
                                            的规则进行填写)</label>
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="form-group form-group-label">
                                        <div class="form-group form-group-label">
                                            ...
                                            <select id="sort" class="form-control" name="sort">
                                                ...
                                                <option value="7" {if $node->sort==7}selected{/if}>PAC PLUS(Socks 代理生成
                                                    PAC文件)
                                                </option>
                                                <option value="8" {if $node->sort==8}selected{/if}>PAC PLUS PLUS(HTTPS
                                                    代理生成 PAC文件)
                                                </option>
                                                <option value="9" {if $node->sort==9}selected{/if}>Shadowsocks 单端口多用户
                                                </option>
                                                <option value="10" {if $node->sort==10}selected{/if}>Shadowsocks 中转
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-label">
                                        <label class="floating-label"
                                               for="node_bandwidth_limit">节点流量上限（不使用的话请填0）（GB）</label>
                                        <input class="form-control" id="node_bandwidth_limit"
                                    ...
                                    <div class="form-group form-group-label">
                                        ...
                                        <input class="form-control" id="bandwidthlimit_resetday"
                                    ...
                                    <div class="form-group form-group-label">
                                        ...
                                        <input class="form-control" id="node_speedlimit" name="node_speedlimit"
