                        ...
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="form-group form-group-label">
                                    <div class="checkbox switch">
                                        <label for="enable">
                                            <input {if $edit_user->enable==1}checked{/if} class="access-hide"
                                                   id="enable" type="checkbox"><span class="switch-toggle"></span>用户启用
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-group-label">
                                    <label for="is_multi_user">
                                        ...
                                        <select id="is_multi_user" class="form-control" name="is_multi_user">
                                            <option value="0" {if $edit_user->is_multi_user==0}selected{/if}>
                                                非单端口多用户承载端口
                                            </option>
                        ...
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="form-group form-group-label">
                                    ...
                                    <input class="form-control" id="protocol" type="text"
                        ...
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="form-group form-group-label">
                                    ...
                                    <input class="form-control" id="auto_reset_bandwidth" type="number"
                        ...
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="form-group form-group-label">
                                    ...
                                    <input class="form-control" id="ref_by" type="text" value="{$edit_user->ref_by}"
                                           readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-main">
                            <div class="card-inner">
                                <div class="form-group form-group-label">
                                    ...
                                    <input class="form-control" id="group" type="number"
                    ...
                    <div class="card">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="form-group form-group-label">
                                    <label class="floating-label" for="node_speedlimit">用户限速，用户在每个节点所享受到的速度(0
                                        为不限制)(Mbps)</label>
