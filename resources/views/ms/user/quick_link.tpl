            ...
            <section class="content-inner margin-top-no">
                <div class="ui-card-wrap">
                                                ...
                                                <div class="tab-pane fade" id="all_ssr_windows">
                                                    <p>
                                                        ...
                                                        (2)点击<a class="copy-text" data-clipboard-text="{$ssr_url_all}">这里（普通端口）</a>或者<a
                                                                class="copy-text" data-clipboard-text="{$ssr_url_all_mu}">这里（单端口多用户）</a>，然后右键小飞机
                                                        -- 从剪贴板复制地址<br>
                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-main" style="min-height: 430px;">
                                <div class="card-inner margin-bottom-no">
                                        ...
                                        <ul class="nav nav-list">
                                            <li {if $ssr_prefer}class="active"{/if}>
                                                <a class="waves-attach" data-toggle="tab" href="#all_zhanghao">
                                                    <i class="icon icon-lg">airplanemode_active</i>&nbsp;帐号使用情况
                                                </a>
                                            </li>
                                            <li>
                                                <a class="waves-attach" data-toggle="tab" href="#all_liuliang">
                                                    <i class="icon icon-lg">flight_takeoff</i>&nbsp;流量使用情况</a>
                                            </li>
                                            <li>
                                                <a class="waves-attach" data-toggle="tab" href="#all_sign">
                                                    <i class="icon icon-lg">flight_takeoff</i>&nbsp;续命获取流量</a>
                                            </li>

                                        </ul>
                                    </nav>

                                    <div class="tab-pane fade active in" id="all_zhanghao">
                                        <dl class="dl-horizontal">
                                            <p>
                                                <dt>帐号等级</dt>
                                            <dd>{$user->class}</dd>
